function cValidate()
{
	...
	this.init = function(){
			//alert('i am at blur');
			jQuery('#contestants-wrap form.contestant-form-validate :input.required1').blur(
				alert('i am here');
				function(){
					alert('i am at blur');
	 ...
	 */
	 this.ajaxValidatePaycode = function(el){
	 	...
	 	//alert(jQuery(el).val());
	 	jaxcontestant.call_contestants('education', 'register','ajaxCheckPaycode',jQuery(el).val());
	 }
	 /**
	 * Check the paycode whether already exisit or not.
	 */
