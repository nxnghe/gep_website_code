...
require_once(JPATH_ROOT.DS.'components'.DS.'com_education'.DS.'libraries'.DS.'core.php');
...
{
	//echo "cImageResizePropotional";exit;
	list($currentWidth, $currentHeight) = getimagesize( $srcPath );
 ...
 */
function cImageCreateThumb($srcPath, $destPath, $destType, $destWidth=137, $destHeight=137)
{
