...
include_once( JPATH_ROOT . DS . 'components' . DS . 'com_contestants' . DS . 'libraries' . DS . 'storage' . DS . 's3_lib.php');
...
class CTableStorageS3 extends JTable
{
	...
	{
		parent::__construct( '#__contestants_storage_s3', 'storageid', $db );
	}
