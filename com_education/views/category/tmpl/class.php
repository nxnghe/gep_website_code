...
?>
<form action="index.php?option=com_education&view=category&layout=class" method="post" id="stuForm" name="stuForm">

    <div>
        <label for="filter_search"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
       <input type="text" name="search" id="search" value="<?php echo $this->classes['search']; ?>" class="text_area" onchange="this.form.submit();" />
	...
	<?php echo $this->loadTemplate('class'); ?>
	<div class="stu_pagination">
		<?php //echo $this->stupagination->getPagesLinks();?>
		<?php echo $this->clapagination->getListFooter();?>
