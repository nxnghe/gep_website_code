...
?>
<form action="index.php?option=com_education&view=category" method="post" id="stuForm" name="stuForm">

    <div>
        <label for="filter_search"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
       <input type="text" name="search" id="search" value="<?php echo $this->students['search']; ?>" class="text_area" onchange="this.form.submit();" />
	...
	<div class="stu_pagination">
		...
		<?php echo $this->stupagination->getListFooter();?>
