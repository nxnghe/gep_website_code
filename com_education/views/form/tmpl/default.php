...
<form action="<?php echo JRoute::_('index.php?option=com_education&task=registration.register'); ?>" method="post" id="conForm" name="conForm" class="contestant-form-validate" enctype="multipart/form-data">
        ...
        -->
        	...
        	<fieldset>
				...
				<table class="contentTable paramlist" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td class="paramlist_value"><input type="text" id="username" name="username" size="40" value="<?php echo ($task=='edit')?$profile->username:' '; ?>" class="required <?php echo ($task!='edit')?'validate-username':' '; ?>" maxlength="25" />
                    ...
                    <tr>
						...
						<td class="paramlist_value"><input type="text" id="email1" name="email1" size="40" value="<?php echo ($task=='edit')?$profile->email:' '; ?>" class="inputbox required <?php echo ($task!='edit')?'validate-email':'' ;?>" maxlength="100" />
				...
				<fieldset>
				<legend style="color:red; text-decoration:underline"><?php echo JText::_( 'GEP CANDIDATE INFOR' );?></legend>
				<table class="contentTable paramlist" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td class="paramlist_value"><input type="text" value="<?php echo ($task=='edit')?$profile->full_name:' '; ?>" id="name" name="name" maxlength="100" size="40" class="conTips tipRight inputbox required" />
					...
					<tr>
						<td class="paramlist_key" valign="top"><label id="parent_namemsg" for="parent_name" class="label" ><span class="red">*</span><?php echo JText::_('GEP PARENT_NAME');?> </label>
						</td>
						<td class="paramlist_value"><input type="text" value="<?php echo ($task=='edit')?$profile->parent_name:' '; ?>" id="parent_name" name="parent_name" maxlength="100" size="40" class="conTips tipRight inputbox required" />
						<span id="errparent_namemsg" class="reerror" style="display:none;">&nbsp;</span>
						</td>
					</tr>
                    <tr>
						...
						<td class="paramlist_value"><select name="gender[]" class="select gender">
							<option value="male" <?php if ($task=='edit') echo ($profile->gender == 'male')?'selected':' ';?>>Male</option>
							<option value="female" <?php if ($task=='edit') echo ($profile->gender == 'female')?'selected':' ';?>>Female</option>
						</select>
					...
					<tr>
						...
						<td class="paramlist_value"><div class="conTips tipRight" style="display: inline-block;">
					...
					<tr>
						...
						<td class="paramlist_value"><input type="text" value="<?php echo ($task=='edit')?$profile->address:' '; ?>" id="address" name="address" maxlength="100" size="40" class="conTips tipRight inputbox required" /> <span id="err_addressmsg"class="reerror" style="display:none;">&nbsp;</span>
						</td>
					</tr>
					<tr>
						...
						<td class="paramlist_value"><input type="text" value="<?php echo ($task=='edit')?$profile->phone:' '; ?>" id="phone" name="phone" maxlength="100" size="40" class="conTips tipRight inputbox norequired" /> <span id="err_phonemsg" class="reerror" style="display:none;">&nbsp;</span>
						</td>
					</tr>
                    ...
                    <tr>
						...
						<td class="paramlist_value"><input type="text" value=" <?php echo ($task=='edit')?$profile->province:' '; ?>" id="province" name="province" maxlength="100" size="40" class="conTips tipRight inputbox" /> <span id="errprovincemsg" class="reerror" style="display:none;">&nbsp;</span>
						</td>
					</tr>
                   <tr>
                        <td class="paramlist_key" valign="top"><label id="about_memsg" for="about_me" class="label" ><span class="red">*</span><?php echo JText::_('GEP ABOUT ME');?></label>
						</td>
						<td class="paramlist_value">
							<TEXTAREA COLS=34 ROWS=5  id="about_me" name="about_me" class="conTips tipRight required" /><?php echo ($task=='edit')?$profile->about_me:' '; ?></TEXTAREA>
                    ...
                    <tr>
						...
						<td class="paramlist_value">
								<input type="file" name="Filedata" class="inputbox conTips tipRight required validate-avatar" id="file-upload" value="<?php echo ($task=='edit')?$profile->avatar:' '; ?>"/>
			...
			<input type="hidden" name="userid" value="<?php echo ($profile->userid > 0)?$profile->userid:" ";?>" />
			<input type="hidden" name="id" value="<?php echo ($profile->id > 0)?$profile->id:" ";?>" />
